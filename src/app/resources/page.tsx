...
const RESOURCES=[
 ...
 {title:'Technology overview',titleKo:'기술 개요',desc:'Public-safe material across PRISM, AXIOM, AXIOM-TENSOR, CRE, FQNM and QNTA, with disclosure boundaries kept explicit.',descKo:'PRISM, AXIOM, AXIOM-TENSOR, CRE, FQNM, QNTA에 대한 공개 가능 자료와 명확한 공개 경계.',href:routes.technology,tone:'info' as const},
];
export const metadata=buildMetadata({title:'Resources',description:'Public references and reading on the products and technologies behind itriX.',path:routes.resources});
