  ...
  return (
    <>
      ...
      <div className="mx-auto flex max-w-3xl flex-col gap-8 px-6 py-8">
        <header>
          <h1 className="font-display text-web-h2 text-ink-primary">{successCopy.knowledge.title}</h1>
          <p className="mt-3 max-w-reading text-web-body text-ink-secondary">{successCopy.knowledge.intro}</p>
        </header>
        {loading ? (
