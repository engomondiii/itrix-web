...
export const PORTAL_STAGE_LINE_KO: Record<PortalStage,string> = {
  review_ready:'리뷰를 확인할 수 있습니다.', briefing_preparing:'itriX 팀이 사례에 맞춘 브리핑을 준비하고 있습니다.', conversation_arranging:'필요한 기밀 대화를 준비하고 있습니다.', evaluation_in_progress:'평가가 진행 중입니다.', poc_underway:'개념검증(PoC)이 진행 중입니다.',
};
export const EVALUATION_STAGE_LINE_KO: Record<EvaluationStage,string> = {
  requested:'요청됨 — itriX 팀이 범위와 다음 단계를 확인하고 있습니다.', scoping:'범위 정의 — 워크로드, 확인할 질문, KPI를 합의하고 있습니다.', in_progress:'진행 중 — 평가를 수행하고 있습니다. 근거가 확인되는 대로 공유합니다.', report_ready:'보고서 준비 완료 — 평가 보고서를 문서에서 확인할 수 있습니다.',
};
export const POC_MILESTONE_LINE_KO: Record<PoCMilestone,string> = {
  planning:'계획 — 워크로드, 성공 기준, 검증 범위를 합의합니다.', setup:'설정 — 환경과 기준선을 준비합니다.', execution:'실행 — 합의된 KPI에 따라 시험하고 결과를 기록합니다.', review:'검토 — 결과를 함께 살펴보고 의미를 확인합니다.', decision:'의사결정 — 통합, 라이선스 또는 추가 작업 여부를 별도로 결정합니다.',
};
