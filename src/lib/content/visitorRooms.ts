...
export const VISITOR_ROOMS: Record<RoomId, RoomContent> = {
  ...
  'technical-assessment': {
    ...
    summary: 'Scope a focused study of one real workload without assuming a PoC or commercial outcome.',
    group: 'operator',
    visitorType: 'technical',
  ...
  investor: {
    ...
    label: 'Investor',
    summary: 'The thesis, the asset-light model, evidence discipline, and route to approved investor information.',
    group: 'capital',
    visitorType: 'investor',
    audience: 'Investors assessing the opportunity',
    intro:
      'The computational-infrastructure thesis, the IP-and-licensing model, and the evidence discipline behind the company. Figures and restricted materials are shared only through the appropriate authorized channel.',
