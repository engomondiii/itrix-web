  ...
  return (
    <section className="section border-b border-line bg-surface-warm">
      <div className="container-page max-w-3xl">
        ...
        <h2 className="mt-4 text-web-h2 text-indigo-950">Accurate framing</h2>

        <Card variant="sunken" className="mt-6">
          <span className="text-micro font-semibold uppercase tracking-[0.06em] text-ink-400">One line</span>
          <p className="mt-2 text-secondary text-ink-900">
        ...
        <Card variant="sunken" className="mt-4">
          <span className="text-micro font-semibold uppercase tracking-[0.06em] text-ink-400">Paragraph</span>
        ...
        <p className="mt-6 text-caption text-ink-400">{NDA_WARNINGS.mechanism} {NDA_WARNINGS.results}</p>
      </div>
    </section>
  );
}
