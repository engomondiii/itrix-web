...
export function CoordinateAxis({ className, size = 120 }: CoordinateAxisProps) {
  return (
    <svg aria-hidden width={size} height={size} viewBox="0 0 120 120" fill="none" className={cn('text-line-strong', className)}>
      ...
      <circle cx="40" cy="76" r="2.5" fill="var(--sapphire-600)" />
      <circle cx="68" cy="52" r="2.5" fill="var(--sapphire-600)" />
      <circle cx="92" cy="34" r="2.5" fill="var(--gold-500)" />
    </svg>
  );
}
