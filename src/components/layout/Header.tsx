  ...
  return (
    <header className="sticky top-0 z-40 border-b border-line bg-surface/90 backdrop-blur supports-[backdrop-filter]:bg-surface/80">
      <div className="container-page flex h-16 items-center justify-between gap-6">
        <Link href={routes.home} className="text-lg font-bold tracking-tight text-indigo-950" aria-label={`${brand.name} home`}>
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="inline-flex h-9 w-9 items-center justify-center rounded-sm text-ink-700 transition-colors hover:bg-surface-sunken md:hidden focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sapphire-600"
          >
